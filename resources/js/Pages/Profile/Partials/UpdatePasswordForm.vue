    ...
    <section>
        <div class="mb-6">
            <p class="text-stone-600 leading-relaxed">
                Keep your financial garden secure with a strong, unique password. We recommend using a mix of letters, numbers, and symbols.
            </p>
        </div>

        <form @submit.prevent="updatePassword" class="space-y-6">
            <div>
                <InputLabel for="current_password" value="Current Password" class="text-stone-700 font-medium" />
            ...
            <div>
                <InputLabel for="password" value="New Password" class="text-stone-700 font-medium" />
